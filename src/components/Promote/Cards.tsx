...
export default function PromotedFunctionsCards({ connection }: { connection: ConnectionPayload | undefined }) {
                ...
                <div className="flex flex-col gap-3">
                    <div className="bg-gradient-to-r from-pink-600 to-rose-700 rounded-lg p-0.5 relative">
                        ...
                        <div className="flex gap-3 bg-[#1F1F1F] rounded-lg p-3 items-center">
                            ...
                            <span className="font-semibold">{connection?.name ?? l.promote.priorityConnection.placeholder}</span>
                        </div>
                    </div>
            ...
            <Container delay={0.3}>
                ...
                <div className="bg-neutral-900/50 rounded-lg w-full flex gap-2 items-center p-4">
                    ...
                    <div>
                        ...
                        <span className="font-semibold break-all">https://i.imgur.com/XsRaBXp_d.webp</span>
                    </div>
                </div>
