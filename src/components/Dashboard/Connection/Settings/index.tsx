...
export default function DashboardConnectionSettings({ connection, setConnection, editedConnection, setEditedConnection }: Props) {
    const l = useLanguage();
    ...
    return (
        ...
        >
            <div>
                <h1 className="font-bold text-xl">{l.dashboard.connections.settings.title}</h1>
                <span className="text-neutral-300">
                    {l.dashboard.connections.settings.description}
                </span>
            </div>
            <div className="flex flex-col">
                <h1 className="mobile:text-4xl text-3xl font-bold bg-clip-text text-transparent 
