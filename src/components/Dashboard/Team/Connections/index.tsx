    ...
    return (
        ...
        >
            <div className="flex flex-col">
                <h1 className="font-bold text-2xl">{l.dashboard.teams.connections.title}</h1>
                <span className="text-neutral-300">{l.dashboard.teams.connections.description}</span>
            </div>
                                ...
                                {query === "" ? (
                                    <div className="flex flex-col">
                                        ...
                                        <div className="text-sm text-neutral-300 font-normal flex gap-1">
                                            <p>{l.dashboard.teams.connections.noConnectionsDescription}</p>
