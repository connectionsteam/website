...
export default function RemoveTeamMember({ id, open, handleRemove }: Props) {
            ...
            <Modal classNames={{
                ...
                <ModalContent className="bg-neutral-800 text-white">
                    <ModalHeader className="pb-1 font-bold">
                        {l.dashboard.teams.members.delete.title}
                    </ModalHeader>
                    <ModalBody className="flex gap-2">
                        <div>
                            {l.dashboard.teams.members.delete.description}{" "}
                            <strong>{id}</strong>?
                        </div>
                    </ModalBody>
                    ...
                    border-neutral-700 mt-2">
                        ...
                        >
                            ...
                            <span className="text-center">{l.dashboard.teams.members.delete.remove}</span>
                        </button>
                    </ModalFooter>
                </ModalContent>
            </Modal>
