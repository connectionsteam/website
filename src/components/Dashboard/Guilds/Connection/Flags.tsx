...
export default function GuildConnectionFlags({
	connection,
	guildId,
	setConnection,
}: Props) {
	...
	const handleFlagChange = async (
		flag: ConnectedConnectionFlags,
		isEnabled: boolean,
	) => {
		const updatedFlags = isEnabled
			? [...flags, flag]
		...
		<div className="flex flex-col gap-4">
			<div className="flex flex-col gap-1">
				<h1 className="text-lg">
					{l.dashboard.guilds.connections.flags.title}
				</h1>
								...
								<div className="flex items-center gap-1">
									<div className="relative">
										{connection.flags.includes(
											...
											<div
												className="absolute top-0 left-0 w-14 h-full 
