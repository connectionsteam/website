...
export default function Cases({ guild }: Props) {
    ...
    const [guildCases, setGuildCases] = useState<AnyCase[]>(guild.cases);
    ...
    //         if (filters.mod_id !== null) queryParams.append("mod_id", filters.mod_id);
        ...
        <div className="flex flex-col gap-4 rounded-lg bg-neutral-800 p-6">
            <div className="flex flex-col">
                <div className="flex items-end">
                    ...
                    <button
                        onClick={onOpen}
                        className="p-2 transition hover:bg-neutral-900 bg-neutral-900/50 rounded-lg relative h-9 mb-2">
                        {(
                            filters.mod_id 
                            || filters.target_id
