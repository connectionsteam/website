        ...
        <section className="flex flex-col gap-4 w-full">
            ...
            <div className="bg-neutral-800 rounded-lg gap-4 flex flex-col w-full p-6">
                ...
                <div className="flex flex-col gap-2">
                    <div className="bg-neutral-700 rounded-full animate-pulse w-24 h-5"></div>
                    <div className="grid grid-cols-2 tablet:grid-cols-1 gap-2">
                        <div className="flex gap-2 items-center bg-neutral-900/50 rounded-lg p-3">
                ...
                <div className="flex flex-col gap-2 w-full">
                    ...
                    <div className="grid grid-cols-3 tablet:grid-cols-1 gap-2 w-full">
                        {Array(3).fill(0).map((_, i) => (
                            <div key={i} className="flex gap-2 items-center bg-neutral-900/50 rounded-lg p-3 min-w-80 mobile:min-w-full h-16">
                                <div className="rounded-full animate-pulse w-12 h-12 bg-neutral-700"></div>
                                <div className="flex flex-col gap-2 text-start">
                                    <div className="bg-neutral-700 h-5 rounded-full animate-pulse w-36 mobile:w-44"></div>
                                    <div className="bg-neutral-700 h-4 rounded-full animate-pulse w-56 mobile:w-44"></div>
                                </div>
                            </div>
                        ))}
                    </div>
