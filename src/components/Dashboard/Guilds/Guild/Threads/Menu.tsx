import type { GuildThreadsPayload } from "../../../../../types";
import {
	Modal,
	ModalBody,
	ModalContent,
			...
			>
				<ModalContent className="bg-neutral-800 text-white">
					<ModalHeader className="flex flex-col gap-1 bg-neutral-800 pb-1">
						{l.dashboard.guilds.threads.thread.delete}
					</ModalHeader>
					<ModalBody className="flex gap-2">
						<div>
							{l.dashboard.guilds.threads.thread.deleteConfirm}{" "}
					...
					>
						...
						>
							...
							<span className="text-center">
								{l.dashboard.guilds.threads.thread.deletetext}
							</span>
						</button>
					</ModalFooter>
				</ModalContent>
