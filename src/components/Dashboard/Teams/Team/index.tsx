...
export default function TeamCard({ team, index, setTeamProps, teamProps, handleDeleteTeam }: Props) {
    return (
        <motion.div
            key={team.id}
            initial={{ opacity: 0 }}
        ...
        >
            <DeleteTeam id={team.name} open={teamProps.hover === team.id} handleRemove={handleDeleteTeam} />
            <Link
                ...
                <Avatar className="w-12 h-12" src={team.iconURL || ""} key={team.name} />
